...
for file_t0 in all_files[:10]:  # Limit for debug (remove later)
    ...
    with Dataset(file_t0, "r") as data_t0:
        ...
        X0_features = pad_observed_storms(storm_database, NB_X0, CONTEXT_DOMAIN_LAT_MIN, CONTEXT_DOMAIN_LAT_MAX, CONTEXT_DOMAIN_LON_MIN, CONTEXT_DOMAIN_LON_MAX)
    ...
    print(f"Processed file {file_t0}")
